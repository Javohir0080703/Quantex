...
const Traders = () => {
  return (
    <div className='py-5 md:py-10 bg-#030D14'>
        <div className={`${components.containerb} p-5  bg-white/[0.02] rounded-3xl`}>
            <p className='text-white/80 text-center text-lg font-semibold mb-6'>Trusted by <span className='text-[#56AB91]'>500,000</span> traders from</p>
